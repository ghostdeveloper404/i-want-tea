...
const Login = () => {
  ...
  return (
    <div className='text-white py-14 container mx-auto'>
       ...
       <div className="bg-transparent grid  justify-center items-center  p-4">
    <p className="md:text-2xl">Social links</p>
    <ul className="ml-3">
        <li className="my-4"><a href="#" aria-label="GITHUB" target="_blank" rel="noopener"
             onClick={() => {signIn("github")}}
                className="w-min flex items-center hover:underline bg-white px-36 py-1 rounded-md text-black transition hover:translate-x-2 hover:no-underline"><svg
        ...
        <li className="my-4"><a href="#" aria-label="FACEBOOK" target="_blank" rel="noopener"
                className="w-min  flex items-center  hover:underline bg-white px-32 py-1 rounded-md text-black transition hover:translate-x-2 hover:no-underline"><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20">
                    <path
